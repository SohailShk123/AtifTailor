...
function Home() {
  return (
    <div className="relative w-full mt-1 bg-black">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center z-10 text-center text-white px-4 md:px-8">
        <h1 className="text-4xl md:text-6xl font-bold">Welcome to TailorShop</h1>
        <p className="text-lg md:text-2xl mt-4">
          Expert tailoring, custom fittings & alterations
        </p>
        <Link to="/contact">
